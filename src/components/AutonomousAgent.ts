...
class AutonomousAgent {
  ...
  async loop() {
    ...
    this.numLoops += 1;
    const maxLoops = this.modelSettings.customApiKey === "" ? 75 : 25;
  ...
  sendLoopMessage() {
    this.sendMessage({
      ...
      value:
        this.modelSettings.customApiKey !== ""
          ? `This agent has been running for too long (100 Loops). To save your wallet, and our infrastructure costs, this agent is shutting down. In the future, the number of iterations will be configurable.`
